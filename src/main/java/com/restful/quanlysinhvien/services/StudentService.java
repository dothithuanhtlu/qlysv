...
public class StudentService {
    ...
    private ClassRoom isExistClassName(String className) throws ClassNameValidationException {
        if(this.classRoomRepository.findByClassName(className)==null) {
            throw new ClassNameValidationException("ClassName is not exist");
        }
        return this.classRoomRepository.findByClassName(className);
    }
    ...
    public void updateStu(StudentUpdateDTO studentUpdateDTO, String stuCode)
        ...
        if (result == 0) {
            throw new RuntimeException("Failed to update student - possibly class is full");
        }
    }

    @Transactional
    public void createStu(StudentDTO studentDTO) throws IdValidationException, EmailValidationException, ClassNameValidationException {
        ...
        if (result == 0) {
            throw new RuntimeException("Failed to create student - possibly class is full");
        }
    }
